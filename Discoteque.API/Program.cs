...
async void PopulateDb(WebApplication app)
{
    using (var scope = app.Services.CreateScope())
    {
        ...
        await albumService.CreateAlbum(new Discoteque.Domain.Models.Album
        {
            ...
            Name = "Unstopabble",
            ArtistId = 1,
            Genre = Discoteque.Domain.Models.Genres.Urban,
        ...
        await albumService.CreateAlbum(new Discoteque.Domain.Models.Album
        {
            ...
            Name = "Fijate Bien",
            ArtistId = 2,
            Genre = Discoteque.Domain.Models.Genres.Rock,
            Cost = new Random().Next(1, 9) * 10_000
        });
        await albumService.CreateAlbum(new Discoteque.Domain.Models.Album
        {
        ...
        await albumService.CreateAlbum(new Discoteque.Domain.Models.Album
        {
            ...
            ArtistId = 4,
            Genre = Discoteque.Domain.Models.Genres.Salsa,
            Cost = new Random().Next(1, 9) * 10_000
        });
        await albumService.CreateAlbum(new Discoteque.Domain.Models.Album
        {
        ...
        await albumService.CreateAlbum(new Discoteque.Domain.Models.Album
        {
            ...
            ArtistId = 5,
            Genre = Discoteque.Domain.Models.Genres.Vallenato,
            Cost = new Random().Next(1, 9) * 10_000
        });
        await albumService.CreateAlbum(new Discoteque.Domain.Models.Album
        {
        ...
        await albumService.CreateAlbum(new Discoteque.Domain.Models.Album
        {
            ...
            Name = "Fonseca",
            ArtistId = 7,
            Genre = Discoteque.Domain.Models.Genres.Pop,
            Cost = new Random().Next(1, 9) * 10_000
        });
        await albumService.CreateAlbum(new Discoteque.Domain.Models.Album
        {
